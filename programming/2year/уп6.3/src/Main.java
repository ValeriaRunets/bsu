...
public class Main extends JFrame {
    ...
    public BranchGroup createSceneGraph(Canvas3D canvas) {
        ...
        font=new Font("TestFont", Font.ROMAN_BASELINE, 1);
        Font3D font3d = new Font3D(font, 0.001, new FontExtrusion(new Line2D.Double(0,0,1,1)));

        text = new Text3D(font3d, "Hello");
    ...
    public Main()
    {
        ...
        buttonLightColor.addActionListener(new ActionListener() {
            @Override
